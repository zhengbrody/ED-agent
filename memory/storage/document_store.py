# this part is modified from Hello-Agent
...
class SQLiteDocumentStore(DocumentStore):
    ...
    def __init__(self, db_path: str = "./memory.db"):
        ...
        if abs_path not in self._initialized_dbs:
            ...
            print(f"[OK] SQLite initialization: {db_path}")
